...
| `semantic-layer-engine-architecture.md` §13 Definition of Done | ✅ COMPLIANT | The 5 ADRs (`docs/adr/`) document the priority ranges (ADR-003), error handling policy (ADR-002 + ADR-004), and the engine-portable architecture (ADR-001). |
