...
**Status:** Implemented — was Proposed (v1.0), promoted to Implemented on the 12-PR atomic-sequence landing (PR-19 at 6bfbc12 was the original PR-19 scope per the ADR; the surface expanded into the SS-prefixed worktree). 10 PRs shipped end-to-end: PR-19 (6bfbc12) typed end-to-end aggregateMeasures + having + partitionBy + window, PR-20 (3a14f68) TypedPredicate + whereFilters, PR-21/22 (bb66da4) typed filter/where end-to-end, PR-23 (8556bca) examples migration to typed QueryBuilderDsl, PR-24 (8e77838) TypedSortKey foundation, PR-25 (eb2f426) typed .asc/.desc sort direction, PR-26 (eded808) TypedMeasure bridge, PR-27 (2e65e8e) semantic + Spark physical plan, PR-28 (eddb4b9) filter pushdown, PR-29 (d566f6c) typed filter ergonomics. ADR-008-L Appendix GAPs 5/6/7/8 + window-function family (ADR-008-P §DE-P2-5) all closed. Local-only `.omp/WATCHDOG.yml` (gitignored) tunes the advisor roster for this project.. **Date:** 2026-08-19. **Author:** SM8 agent (PR-M4 per ADR-008-L §"Remediation sequence"; design expanded to include window functions per user priority message 2026-08-19).
