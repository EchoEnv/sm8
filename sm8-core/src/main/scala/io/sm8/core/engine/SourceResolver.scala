 ...
 *
 * Per [[scala-jvm-safety-mindset]]: zero spark imports; pure data
...
/** Result of resolving a portable `SourceRef` against a
  ...
  *
  * Per [[scala-error-handling-mindset]]: the failure cases
...
object ResolvedSource {
  ...
  /** Successful resolution. Carries the actual schema (after
    ...
    *
    * Per [[scala-spark-batch-bugs-mindset]] mantra #3 (schema-
