 ...
 * Per [[scala-data-driven-refactor-mindset]] §3: default to sealed-trait
 ...
 *
 * [[karpathy-guidelines-mindset]] §3 (smallest correct change): one
 ...
 *
 * Per [[scala-data-driven-refactor-mindset]] §1 "behavior lives elsewhere":
 ...
 * looked up by name.
 *
 * Per [[scala-jvm-safety-mindset]] §2: this trait `extends Serializable`
...
object EngineUrlParser {
  /** SPI lookup: discover all registered parsers + return the one
    ...
    *
    * Per [[scala-error-handling-mindset]] §1: typed error, not silent
