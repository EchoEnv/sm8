...
| `FreshnessPolicy.FinalRequired` | STEP 2 declaration; with the policy set, `stalenessRefusal` returns `RollupBucketStale` for any unsealed bucket the probe covers |
